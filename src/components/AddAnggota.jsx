...
const Sidebar = () => {
  const [data, setData] = useState({ nis: "", nama: "", jenis_kelamin: "", telp: "" });
  const [sideBarOpen, setSideBarOpen] = useState(false);

  const url = "http://localhost:3000/anggota";
        ...
        <div className="flex min-h-screen">
          ...
          <div className="flex-1 md:ml-5 ml-3 mt-5">
            <div className="flex justify-between">
              <p className="sm:text-3xl text-2xl font-semibold">Tambah Data Anggota</p>
            ...
            <form className="w-full max-w-lg mx-auto p-6 rounded shadow-md" onSubmit={handleSubmit}>
              ...
              <div className="mb-4 mt-5">
                ...
                <input className="form-radio" id="jenis_kelamin" type="radio" name="jenis_kelamin" value="Laki-Laki" checked={data.jenis_kelamin === "Laki-Laki"} onChange={handleChange} />
                <label htmlFor="laki-laki" className="font-semibold md:font-medium ml-3">
                  Laki - Laki
                </label>
                <input className="form-radio ml-5" id="jenis_kelamin" type="radio" name="jenis_kelamin" value="Perempuan" checked={data.jenis_kelamin === "Perempuan"} onChange={handleChange} />
